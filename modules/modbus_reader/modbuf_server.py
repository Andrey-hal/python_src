...
# --------------------------------------------------------------------------- #
config = Conf("modbus_reader_test.ini").config  # TODO заменить на основной
...
class CustomDataBlock(ModbusSparseDataBlock):
    ...
    def setValues(self, address, value):
        ...
        # frame = [(name, value[i]) for i, name in enumerate(read_structure.values())]
        val = bytes_unpack(address, value)
